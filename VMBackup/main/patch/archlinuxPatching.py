...
class archlinuxPatching(AbstractPatching):
    def __init__(self,logger,distro_info):
        super(archlinuxPatching,self).__init__(distro_info)
        self.logger = logger
        self.usr_flag = 0
    ...
    def install_extras(self):
        ...
        for extra in common_extras:
            self.logger.log("installation for " + extra + 'result is ' + str(subprocess.call(['pacman', '-S','--noconfirm', extra])))
