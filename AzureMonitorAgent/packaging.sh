...
rm -rf packages MetricsExtensionBin ext/future amaCoreAgentBin agentLauncherBin mdsdBin tmp
mkdir -p packages MetricsExtensionBin ext/future amaCoreAgentBin agentLauncherBin mdsdBin
...
zip -r $output_path/$PACKAGE_NAME * -x $excluded_files "./test/*" "./extension-test/*" "./references" "./ext/python-future/*" "./ext/future/future/backports/test/*" "./tmp"
